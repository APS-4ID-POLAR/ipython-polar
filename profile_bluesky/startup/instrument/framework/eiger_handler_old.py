...
Based on NSLS2-CHX (08/11/2021):
https://github.com/NSLS-II-CHX/eiger-io/blob/master/eiger_io/fs_handler.py 

only difference is that our file names do not havee seq_id!   
"""
...
class EigerHandler(HandlerBase):
    ...
    def __init__(self, fpath, images_per_file=None, frame_per_point=None):
        ...
        if images_per_file is None:
            ...
            print(f"got images_per_file = {images_per_file}")
    ...
    def get_file_list(self, datum_kwargs, seq_id):
        ''' get the file list.
